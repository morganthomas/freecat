...
The previous statements locate FreeCat in the space of conceptual paradigms discussed in this section. FreeCat is a pure typed functional programming language and an approach to the foundations of math. It is founded on a form of inconsistent constructive type theory.
